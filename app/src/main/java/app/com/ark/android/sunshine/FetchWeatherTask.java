...
//    }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(locationCursor.moveToFirst()){
            ...
            Uri insertedUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI,testValues);
...
//                mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArrary);
//            }
//
...
//                } while (cur.moveToNext());
                inserted = mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI,cvArrary);
            }
